...
The Refield ratio was calculated in 1934 based on samples from different oceans showing a consistent ratio of Carbon, Nitrogen, and Phosphorus in phytoplankton. Caluculating this ratio in different samples can show us the limiting factors of growth in those communities, and gain insight into the health of the ocean.
...
The generated plot shows the total nitrogen (sum of nitrate, nitrite, and ammonium) on the y axis, and phosphate on the x axis. Most of the samples show a linear relationship between these two, revealing a general consistency, yet the slope is smaller from the Redfield ratio, showing that these samples are possibly one of the cases with varied ratio e.g diatoms or fast growing cells.
