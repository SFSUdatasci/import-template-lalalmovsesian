...
Practicing data visualization following "Week 8-10" instructions from the textbook using data from 10 sites in Ecorestore project, monitoring human activities. The goal of this assignment is to create a visual comparative bar chart of human activity types across sites, and display the corresponding location on an interactive map.
...
*first, taking a moment to enjoy the neat plot and nice colors, then:*
